          ...
          <ListItem className={classes.listItem}>
            ...
            >
              <Box display="flex" alignItems="center" mr={2}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 480.33 396.65"
                  className={classes.navLinkIcon}
                >
                  <path
                    d="M448.5,61.75c-1.49.08-3,.22-4.47.22H55.47c-1.49,0-3-.14-4.47-.22A8.18,8.18,0,0,1,53.25,61C65,61,76.75,61,88.5,61q178.32,0,356.62,0A16.19,16.19,0,0,1,448.5,61.75Z"
                    transform="translate(-9.58 -61)"
                  />
                  <path
                    d="M116.22,121.85c5.65,11.52,10.89,22.32,16.22,33.08q23.81,48,47.75,96a15.26,15.26,0,0,0,4.93,5.4c4.41,3.07,5,7.34,4.65,12.08-2.47,31.08-19,53.07-46.23,66.31-32.92,16-66,14.48-97.09-5.41C23.87,314.86,11.58,293.6,9.62,266.65c-.33-4.5,1.59-7.5,5.16-10.11a17.55,17.55,0,0,0,5-6.15q36-71.62,71.75-143.33c3.35-6.72,6.38-7.69,13.06-4.63a14.26,14.26,0,0,0,5.77,1.1c28.7.07,57.4,0,86.1.14,3.5,0,5.33-.85,6.12-4.35C207.57,77,230,61.84,249.71,62c21.61.15,40.52,15,47.14,37.4.36,1.21.81,2.4,1.42,4.21H304q42,0,83.92,0a17.15,17.15,0,0,0,6.85-1.14c6.37-2.83,9.46-1.94,12.69,4.46Q420.64,133,433.69,159.2q23.24,46.49,46.48,93c.72,1.45,1.48,3.45,2.73,4,8.51,3.51,7.34,10.54,6.28,17.2-6.78,42.53-41.69,66.44-75,70.57-34.51,4.29-64-5.34-87-31.93-11.26-13-16.88-28.41-17.64-45.55-.21-4.65,1.12-8.58,5.87-10.77a7.57,7.57,0,0,0,3.19-3.44Q350,189,381.27,125.75c.55-1.1.89-2.3,1.58-4.11-2.25-.18-4-.43-5.71-.43-24.86,0-49.72.08-74.59-.11-4.19,0-5.87,1.21-7.09,5.31-5,16.88-16.41,27.88-33.43,32.24-5.35,1.37-6.3,3.55-6.29,8.44q.22,89.78.09,179.54c0,7.82,0,7.82-7.79,7.85a24.06,24.06,0,0,0-3.29,0c-5.31.72-6.8-1.59-6.79-6.8.16-60,0-120.06.22-180.09,0-5.21-1.12-7.85-6.4-10-14.6-5.81-24.19-16.61-28.19-32-.69-2.62-1.3-4.56-4.85-4.54-26.32.15-52.65.08-79,.11A26.57,26.57,0,0,0,116.22,121.85ZM37.1,255.16H162.66c-21-42-41.73-83.29-63-125.82C78.42,172,57.87,213.37,37.1,255.16Zm425.34.32-62.7-126.14L336.58,255.48Z"
                    transform="translate(-9.58 -61)"
                  />
                  <path
                    d="M249.13,457.55c-28.68,0-57.36-.1-86,.1-4.94,0-6.89-1.26-6.5-6.43a152.3,152.3,0,0,0,0-17.49c-.14-3.65,1.39-5,4.83-4.72.91.07,1.83,0,2.74,0h171c7.47,0,7.47,0,7.48,7.47,0,5.1-.28,10.22.08,15.3.33,4.64-1.46,5.88-5.93,5.85C307.58,457.47,278.35,457.55,249.13,457.55Z"
                    transform="translate(-9.58 -61)"
                  />
                  <path
                    d="M309.06,413.65H190.51c-.23-9.77,3.88-17.69,10-24.56,10.87-12.26,25.14-17.79,41.13-19,21.6-1.7,41.57,2.17,57.06,18.84A37.14,37.14,0,0,1,309.06,413.65Z"
                    transform="translate(-9.58 -61)"
                  />
                </svg>
              </Box>
              <Typography component="span">Vote</Typography>
            </NavLink>
          </ListItem>
        </List>
      </Box>
